...
-(void)doCalculations
{
    ...
    if((self.waitingOperand==nil)&&(self.waitingOperation==NAN)&&(self.incomingOperand==nil))
    {
        //All variables are nil:
        //nil _ nil
        
    }else if((self.waitingOperand==nil)&&(self.waitingOperation==NAN)&&(self.incomingOperand!=nil))
    {
